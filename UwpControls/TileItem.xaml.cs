...
public sealed partial class TileItem : UserControl
{
    ...
    /// </summary>
    public static readonly DependencyProperty TitleForegroundProperty = DependencyObjectProxy.RegisterProperty<Brush>(nameof(TitleForeground), new SolidColorBrush(Colors.Gray));
    ...
    /// </summary>
    public static readonly DependencyProperty DescriptionForegroundProperty = DependencyObjectProxy.RegisterProperty<Brush>(nameof(DescriptionForeground), new SolidColorBrush(Colors.Gray));
    ...
    /// </summary>
    public IList<Windows.UI.Xaml.Documents.TextHighlighter> TitleHighlighters => TitleText.TextHighlighters;

    /// <summary>
    /// Gets the collection of description highlights.
    /// </summary>
    public IList<Windows.UI.Xaml.Documents.TextHighlighter> DescriptionHighlighters => DescriptionText.TextHighlighters;
